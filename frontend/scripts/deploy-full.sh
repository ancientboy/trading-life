...
echo "==> 上传后端 Python..."
for f in api.py life_game.py life_db.py life_auth.py life_engagement.py life_trading.py agent_brain.py poker_hands.py poker_engine.py poker_bot.py poker_style.py poker_advanced.py; do
